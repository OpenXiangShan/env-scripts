...
`ifdef CONFIG_USE_IMSIC
          .imsic_axi4lite_awready  (io_imsic_awready[i]),
          .imsic_axi4lite_awvalid  (io_imsic_awvalid[i]),
          .imsic_axi4lite_awid     (io_imsic_awid[i]),
          .imsic_axi4lite_awaddr   (io_imsic_awaddr[i]),
          .imsic_axi4lite_wready   (io_imsic_wready[i]),
          .imsic_axi4lite_wvalid   (io_imsic_wvalid[i]),
          .imsic_axi4lite_wdata    (io_imsic_wdata[i]),
          .imsic_axi4lite_bready   (io_imsic_bready[i]),
          .imsic_axi4lite_bvalid   (io_imsic_bvalid[i]),
          .imsic_axi4lite_bid      (io_imsic_bid[i]),
          .imsic_axi4lite_bresp    (io_imsic_bresp[i]),
          .imsic_axi4lite_arready  (io_imsic_arready[i]),
          .imsic_axi4lite_arvalid  (io_imsic_arvalid[i]),
          .imsic_axi4lite_arid     (io_imsic_arid[i]),
          .imsic_axi4lite_araddr   (io_imsic_araddr[i]),
          .imsic_axi4lite_rready   (io_imsic_rready[i]),
          .imsic_axi4lite_rvalid   (io_imsic_rvalid[i]),
          .imsic_axi4lite_rid      (io_imsic_rid[i]),
          .imsic_axi4lite_rdata    (io_imsic_rdata[i]),
          .imsic_axi4lite_rresp    (io_imsic_rresp[i])
`else
          .imsic_axi4lite_awready  (),
          .imsic_axi4lite_awvalid  (1'b0),
          .imsic_axi4lite_awid     (5'b0),
          .imsic_axi4lite_awaddr   (32'b0),
          .imsic_axi4lite_wready   (),
          .imsic_axi4lite_wvalid   (1'b0),
          .imsic_axi4lite_wdata    (32'b0),
          .imsic_axi4lite_bready   (1'b0),
          .imsic_axi4lite_bvalid   (),
          .imsic_axi4lite_bid      (),
          .imsic_axi4lite_bresp    (),
          .imsic_axi4lite_arready  (),
          .imsic_axi4lite_arvalid  (1'b0),
          .imsic_axi4lite_arid     (5'b0),
          .imsic_axi4lite_araddr   (32'b0),
          .imsic_axi4lite_rready   (1'b0),
          .imsic_axi4lite_rvalid   (),
          .imsic_axi4lite_rid      (),
          .imsic_axi4lite_rdata    (),
          .imsic_axi4lite_rresp    ()
`endif /* CONFIG_USE_IMSIC */
      );
