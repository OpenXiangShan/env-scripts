...
// DDR arbitration outputs (to real DDR controller)
output         difftest_ddr_mem_awready,
input          difftest_ddr_mem_awvalid,
input  [63:0]  difftest_ddr_mem_awaddr,
input  [2:0]   difftest_ddr_mem_awprot,
input          difftest_ddr_mem_awid,
input  [7:0]   difftest_ddr_mem_awlen,
input  [2:0]   difftest_ddr_mem_awsize,
input  [1:0]   difftest_ddr_mem_awburst,
input          difftest_ddr_mem_awlock,
input  [3:0]   difftest_ddr_mem_awcache,
input  [3:0]   difftest_ddr_mem_awqos,
input          difftest_ddr_mem_awuser,
output         difftest_ddr_mem_wready,
input          difftest_ddr_mem_wvalid,
input  [255:0] difftest_ddr_mem_wdata,
input  [31:0]  difftest_ddr_mem_wstrb,
input          difftest_ddr_mem_wlast,
input          difftest_ddr_mem_bready,
output         difftest_ddr_mem_bvalid,
output         difftest_ddr_mem_bid,
output [1:0]   difftest_ddr_mem_bresp,
output         difftest_ddr_mem_buser,
output         difftest_ddr_mem_arready,
input          difftest_ddr_mem_arvalid,
input  [63:0]  difftest_ddr_mem_araddr,
input  [2:0]   difftest_ddr_mem_arprot,
input          difftest_ddr_mem_arid,
input  [7:0]   difftest_ddr_mem_arlen,
input  [2:0]   difftest_ddr_mem_arsize,
input  [1:0]   difftest_ddr_mem_arburst,
input          difftest_ddr_mem_arlock,
input  [3:0]   difftest_ddr_mem_arcache,
input  [3:0]   difftest_ddr_mem_arqos,
input          difftest_ddr_mem_aruser,
input          difftest_ddr_mem_rready,
output         difftest_ddr_mem_rvalid,
output         difftest_ddr_mem_rid,
output [255:0] difftest_ddr_mem_rdata,
output [1:0]   difftest_ddr_mem_rresp,
output         difftest_ddr_mem_rlast,
output         difftest_ddr_mem_ruser
);
...
SimTop  u_XSTop(
  ...
  // DDR arbitration: CPU mem input (from wrapper's mem_core_*)
  .difftest_cpu_mem_awready        (mem_core_awready),
  .difftest_cpu_mem_awvalid        (mem_core_awvalid),
  .difftest_cpu_mem_awaddr         ({28'b0, mem_core_awaddr}),
  .difftest_cpu_mem_awprot         (mem_core_awprot),
  .difftest_cpu_mem_awid           (mem_core_awid[0]),
  .difftest_cpu_mem_awlen          (mem_core_awlen),
  .difftest_cpu_mem_awsize         (mem_core_awsize),
  .difftest_cpu_mem_awburst        (mem_core_awburst),
  .difftest_cpu_mem_awlock         (mem_core_awlock),
  .difftest_cpu_mem_awcache        (mem_core_awcache),
  .difftest_cpu_mem_awqos          (mem_core_awqos),
  .difftest_cpu_mem_awuser         (1'b0),
  .difftest_cpu_mem_wready         (mem_core_wready),
  .difftest_cpu_mem_wvalid         (mem_core_wvalid),
  .difftest_cpu_mem_wdata          ({15744'b0, mem_core_wdata}),
  .difftest_cpu_mem_wstrb          ({1968'b0, mem_core_wstrb}),
  .difftest_cpu_mem_wlast          (mem_core_wlast),
  .difftest_cpu_mem_bready         (mem_core_bready),
  .difftest_cpu_mem_bvalid         (mem_core_bvalid),
  .difftest_cpu_mem_bid            (mem_core_bid[0]),
  .difftest_cpu_mem_bresp          (mem_core_bresp),
  .difftest_cpu_mem_buser          (),
  .difftest_cpu_mem_arready        (mem_core_arready),
  .difftest_cpu_mem_arvalid        (mem_core_arvalid),
  .difftest_cpu_mem_araddr         ({28'b0, mem_core_araddr}),
  .difftest_cpu_mem_arprot         (mem_core_arprot),
  .difftest_cpu_mem_arid           (mem_core_arid[0]),
  .difftest_cpu_mem_arlen          (mem_core_arlen),
  .difftest_cpu_mem_arsize         (mem_core_arsize),
  .difftest_cpu_mem_arburst        (mem_core_arburst),
  .difftest_cpu_mem_arlock         (mem_core_arlock),
  .difftest_cpu_mem_arcache        (mem_core_arcache),
  .difftest_cpu_mem_arqos          (mem_core_arqos),
  .difftest_cpu_mem_aruser         (1'b0),
  .difftest_cpu_mem_rready         (mem_core_rready),
  .difftest_cpu_mem_rvalid         (mem_core_rvalid),
  .difftest_cpu_mem_rid            (mem_core_rid[0]),
  .difftest_cpu_mem_rdata          ({15744'b0, mem_core_rdata}),
  .difftest_cpu_mem_rresp          (mem_core_rresp),
  .difftest_cpu_mem_rlast          (mem_core_rlast),
  .difftest_cpu_mem_ruser          (),

  // DDR arbitration: DDR mem output (to core_def_xdma)
  .difftest_ddr_mem_awready        (difftest_ddr_mem_awready),
  .difftest_ddr_mem_awvalid        (difftest_ddr_mem_awvalid),
  .difftest_ddr_mem_awaddr         (difftest_ddr_mem_awaddr),
  .difftest_ddr_mem_awprot         (difftest_ddr_mem_awprot),
  .difftest_ddr_mem_awid           (difftest_ddr_mem_awid),
  .difftest_ddr_mem_awlen          (difftest_ddr_mem_awlen),
  .difftest_ddr_mem_awsize         (difftest_ddr_mem_awsize),
  .difftest_ddr_mem_awburst        (difftest_ddr_mem_awburst),
  .difftest_ddr_mem_awlock         (difftest_ddr_mem_awlock),
  .difftest_ddr_mem_awcache        (difftest_ddr_mem_awcache),
  .difftest_ddr_mem_awqos          (difftest_ddr_mem_awqos),
  .difftest_ddr_mem_awuser         (difftest_ddr_mem_awuser),
  .difftest_ddr_mem_wready         (difftest_ddr_mem_wready),
  .difftest_ddr_mem_wvalid         (difftest_ddr_mem_wvalid),
  .difftest_ddr_mem_wdata          (difftest_ddr_mem_wdata),
  .difftest_ddr_mem_wstrb          (difftest_ddr_mem_wstrb),
  .difftest_ddr_mem_wlast          (difftest_ddr_mem_wlast),
  .difftest_ddr_mem_bready         (difftest_ddr_mem_bready),
  .difftest_ddr_mem_bvalid         (difftest_ddr_mem_bvalid),
  .difftest_ddr_mem_bid            (difftest_ddr_mem_bid),
  .difftest_ddr_mem_bresp          (difftest_ddr_mem_bresp),
  .difftest_ddr_mem_buser          (difftest_ddr_mem_buser),
  .difftest_ddr_mem_arready        (difftest_ddr_mem_arready),
  .difftest_ddr_mem_arvalid        (difftest_ddr_mem_arvalid),
  .difftest_ddr_mem_araddr         (difftest_ddr_mem_araddr),
  .difftest_ddr_mem_arprot         (difftest_ddr_mem_arprot),
  .difftest_ddr_mem_arid           (difftest_ddr_mem_arid),
  .difftest_ddr_mem_arlen          (difftest_ddr_mem_arlen),
  .difftest_ddr_mem_arsize         (difftest_ddr_mem_arsize),
  .difftest_ddr_mem_arburst        (difftest_ddr_mem_arburst),
  .difftest_ddr_mem_arlock         (difftest_ddr_mem_arlock),
  .difftest_ddr_mem_arcache        (difftest_ddr_mem_arcache),
  .difftest_ddr_mem_arqos          (difftest_ddr_mem_arqos),
  .difftest_ddr_mem_aruser         (difftest_ddr_mem_aruser),
  .difftest_ddr_mem_rready         (difftest_ddr_mem_rready),
  .difftest_ddr_mem_rvalid         (difftest_ddr_mem_rvalid),
  .difftest_ddr_mem_rid            (difftest_ddr_mem_rid),
  .difftest_ddr_mem_rdata          (difftest_ddr_mem_rdata),
  .difftest_ddr_mem_rresp          (difftest_ddr_mem_rresp),
  .difftest_ddr_mem_rlast          (difftest_ddr_mem_rlast),
  .difftest_ddr_mem_ruser          (difftest_ddr_mem_ruser),
