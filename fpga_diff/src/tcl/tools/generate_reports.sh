...
PROJ_FILE=/nfs/home/fengkehan/project/env-scripts/fpga_diff/fpga_${CPU}/fpga_${CPU}.xpr
vivado -mode tcl -nojournal -nolog -notrace -source /nfs/home/fengkehan/project/env-scripts/fpga_diff/src/tcl/tools/generate_reports.tcl -tclargs "${OUT_FILE}" "${PROJ_FILE}"