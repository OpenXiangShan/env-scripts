...
set uvhs_replacements [regsub -line {^config_hw[ \t]+-assemble[ \t]*$} $uvhs_base_data "$uvhs_late_overlay\nconfig_hw -assemble" uvhs_patched_data]
if {$uvhs_replacements != 1} {
    error "failed to patch assembly file before config_hw -assemble: $uvhs_base_assemble"
}

set uvhs_overlay_file [file join [pwd] script .uvhs_assemble_single_fpga.tcl]
