...
# parameters.
#
# Keep this disabled by default. Enabling probe_net can instantiate UVHS/UHD
# capture resources and has previously moved the workload DDR binding from the
# known-good F2/FMC3 connector to F2/FMC2, where DDR initialization fails on this
# setup. Set UVHS_ENABLE_PROBE_NET=1 only for a build whose runtime query proves
# the workload DDR still initializes on FMC3.
