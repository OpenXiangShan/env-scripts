...
def xs_run(server_list, workloads, xs_path, warmup, max_instr, threads, version=2006, dry_run=False, verbose=True, emu_path=None):
  if emu_path is None:
...
if __name__ == "__main__":
  ...
  if args.show:
    ...
    print("First:", gcpt[0])
    print("Last: ", gcpt[-1])
    xs_run(args.server_list, gcpt, args.xs, args.warmup, args.max_instr, args.threads, args.version, args.dry_run, args.verbose, args.xs_emu)
