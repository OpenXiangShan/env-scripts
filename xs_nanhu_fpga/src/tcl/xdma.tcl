...
# 
# designed by Zhang Shize from BOSC 
################################################################
...
proc create_root_design { parentCell } {
  ...
  set XDMA_S_AXI_B [ create_bd_intf_port -mode Slave -vlnv xilinx.com:interface:aximm_rtl:1.0 XDMA_S_AXI_B ]
  ...
  set pcie_axi [ create_bd_intf_port -mode Slave -vlnv xilinx.com:interface:aximm_rtl:1.0 pcie_axi ]
  set_property -dict [ list \
   CONFIG.ADDR_WIDTH {40} \
   CONFIG.ARUSER_WIDTH {0} \
   CONFIG.AWUSER_WIDTH {0} \
  ...
  set_property -dict [ list \
   CONFIG.ASSOCIATED_BUSIF {frontbus_axi:pcie_axi:XDMA_S_AXI_B} \
 ] $aclk
  ...
  connect_bd_intf_net -intf_net S00_AXI_0_1 [get_bd_intf_ports pcie_axi] [get_bd_intf_pins axi_clock_converter_1/S_AXI]
...
connect_bd_intf_net -intf_net [get_bd_intf_nets S00_AXI_1] [get_bd_intf_pins axi_clock_converter_1/M_AXI] [get_bd_intf_pins ila_5/SLOT_0_AXI]
  connect_bd_intf_net -intf_net XDMA_S_AXI_B_1 [get_bd_intf_ports XDMA_S_AXI_B] [get_bd_intf_pins axi_clock_converter_2/S_AXI]
connect_bd_intf_net -intf_net [get_bd_intf_nets XDMA_S_AXI_B_1] [get_bd_intf_ports XDMA_S_AXI_B] [get_bd_intf_pins ila_6/SLOT_0_AXI]
...
connect_bd_intf_net -intf_net [get_bd_intf_nets axi_clock_converter_0_M_AXI] [get_bd_intf_pins axi_clock_converter_0/M_AXI] [get_bd_intf_pins ila_1/SLOT_0_AXI]
...
connect_bd_intf_net -intf_net [get_bd_intf_nets axi_clock_converter_2_M_AXI] [get_bd_intf_pins axi_clock_converter_2/M_AXI] [get_bd_intf_pins ila_4/SLOT_0_AXI]
...
connect_bd_intf_net -intf_net [get_bd_intf_nets axi_clock_converter_3_M_AXI] [get_bd_intf_pins axi_clock_converter_3/M_AXI] [get_bd_intf_pins ila_0/SLOT_0_AXI]
...
connect_bd_intf_net -intf_net [get_bd_intf_nets xdma_0_M_AXI_B] [get_bd_intf_pins ila_3/SLOT_0_AXI] [get_bd_intf_pins xdma_0/M_AXI_B]
  ...
  connect_bd_net -net Net [get_bd_ports aresetn] [get_bd_pins axi_clock_converter_1/s_axi_aresetn] [get_bd_pins axi_clock_converter_2/s_axi_aresetn] [get_bd_pins proc_sys_reset_1/ext_reset_in] [get_bd_pins xdma_0/sys_rst_n] [get_bd_pins xdma_1/sys_rst_n]
  connect_bd_net -net Net2 [get_bd_pins axi_interconnect_1/M00_AXI_awaddr] [get_bd_pins system_ila_4/probe2] [get_bd_pins xdma_1/s_axib_awaddr]
  connect_bd_net -net Net3 [get_bd_pins axi_interconnect_1/M00_AXI_wdata] [get_bd_pins system_ila_4/probe3] [get_bd_pins xdma_1/s_axib_wdata]
  connect_bd_net -net Net4 [get_bd_pins axi_interconnect_0/M00_AXI_wdata] [get_bd_pins system_ila_0/probe3] [get_bd_pins xdma_0/s_axil_wdata]
  connect_bd_net -net Net5 [get_bd_pins axi_interconnect_0/M01_AXI_araddr] [get_bd_pins system_ila_0/probe4] [get_bd_pins xdma_0/s_axib_araddr]
  connect_bd_net -net Net6 [get_bd_pins axi_interconnect_0/M01_AXI_awaddr] [get_bd_pins system_ila_0/probe6] [get_bd_pins xdma_0/s_axib_awaddr]
  connect_bd_net -net Net7 [get_bd_pins axi_interconnect_0/M01_AXI_wdata] [get_bd_pins system_ila_0/probe7] [get_bd_pins xdma_0/s_axib_wdata]
  connect_bd_net -net S00_ACLK_0_1 [get_bd_ports aclk] [get_bd_pins axi_clock_converter_0/m_axi_aclk] [get_bd_pins axi_clock_converter_1/s_axi_aclk] [get_bd_pins axi_clock_converter_2/s_axi_aclk] [get_bd_pins axi_clock_converter_3/m_axi_aclk] [get_bd_pins axi_interconnect_2/ACLK] [get_bd_pins axi_interconnect_2/M00_ACLK] [get_bd_pins axi_interconnect_2/S00_ACLK] [get_bd_pins axi_interconnect_2/S01_ACLK] [get_bd_pins ila_0/clk] [get_bd_pins ila_1/clk] [get_bd_pins ila_2/clk] [get_bd_pins ila_6/clk] [get_bd_pins proc_sys_reset_1/slowest_sync_clk]
  ...
  connect_bd_net -net m_axib_araddr [get_bd_pins axi_clock_converter_3/s_axi_araddr] [get_bd_pins system_ila_4/probe6] [get_bd_pins xdma_1/m_axib_araddr]
  set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_nets m_axib_araddr]
  ...
  connect_bd_net -net s_axi_rdata [get_bd_pins axi_clock_converter_3/s_axi_rdata] [get_bd_pins system_ila_4/probe7] [get_bd_pins xdma_1/m_axib_rdata]
  set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_nets s_axi_rdata]
  connect_bd_net -net s_axil_rdata [get_bd_pins axi_interconnect_0/M00_AXI_rdata] [get_bd_pins system_ila_0/probe0] [get_bd_pins xdma_0/s_axil_rdata]
  set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_nets s_axil_rdata]
  ...
  connect_bd_net -net util_vector_logic_0_Res [get_bd_pins system_ila_0/probe1] [get_bd_pins util_vector_logic_0/Res] [get_bd_pins xdma_0/s_axil_araddr]
  set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_nets util_vector_logic_0_Res]
  connect_bd_net -net util_vector_logic_1_Res [get_bd_pins system_ila_0/probe2] [get_bd_pins util_vector_logic_1/Res] [get_bd_pins xdma_0/s_axil_awaddr]
  connect_bd_net -net util_vector_logic_2_Res [get_bd_pins system_ila_4/probe0] [get_bd_pins util_vector_logic_2/Res] [get_bd_pins xdma_1/s_axil_araddr]
  connect_bd_net -net util_vector_logic_3_Res [get_bd_pins system_ila_4/probe1] [get_bd_pins util_vector_logic_3/Res] [get_bd_pins xdma_1/s_axil_awaddr]
  connect_bd_net -net xdma_0_axi_aclk1 [get_bd_ports dma_axi_aclk] [get_bd_pins axi_clock_converter_0/s_axi_aclk] [get_bd_pins axi_clock_converter_1/m_axi_aclk] [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins axi_interconnect_0/M01_ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins ila_3/clk] [get_bd_pins ila_5/clk] [get_bd_pins proc_sys_reset_0/slowest_sync_clk] [get_bd_pins system_ila_0/clk] [get_bd_pins xdma_0/axi_aclk]
  ...
  connect_bd_net -net xdma_0_s_axib_rdata [get_bd_pins axi_interconnect_0/M01_AXI_rdata] [get_bd_pins system_ila_0/probe5] [get_bd_pins xdma_0/s_axib_rdata]
  connect_bd_net -net xdma_1_axi_aclk [get_bd_pins axi_clock_converter_2/m_axi_aclk] [get_bd_pins axi_clock_converter_3/s_axi_aclk] [get_bd_pins axi_interconnect_0/M02_ACLK] [get_bd_pins axi_interconnect_1/ACLK] [get_bd_pins axi_interconnect_1/M00_ACLK] [get_bd_pins axi_interconnect_1/S00_ACLK] [get_bd_pins axi_interconnect_1/S01_ACLK] [get_bd_pins ila_4/clk] [get_bd_pins jtag_axi_0/aclk] [get_bd_pins system_ila_4/clk] [get_bd_pins xdma_1/axi_aclk]
  connect_bd_net -net xdma_1_axi_aresetn [get_bd_pins axi_clock_converter_2/m_axi_aresetn] [get_bd_pins axi_clock_converter_3/s_axi_aresetn] [get_bd_pins axi_interconnect_1/ARESETN] [get_bd_pins axi_interconnect_1/M00_ARESETN] [get_bd_pins axi_interconnect_1/S00_ARESETN] [get_bd_pins axi_interconnect_1/S01_ARESETN] [get_bd_pins jtag_axi_0/aresetn] [get_bd_pins xdma_1/axi_aresetn]
  ...
  connect_bd_net -net xdma_1_m_axib_awaddr [get_bd_pins axi_clock_converter_3/s_axi_awaddr] [get_bd_pins system_ila_4/probe4] [get_bd_pins xdma_1/m_axib_awaddr]
  connect_bd_net -net xdma_1_m_axib_wdata [get_bd_pins axi_clock_converter_3/s_axi_wdata] [get_bd_pins system_ila_4/probe5] [get_bd_pins xdma_1/m_axib_wdata]
  ...
  assign_bd_address -offset 0x60000000 -range 0x20000000 -target_address_space [get_bd_addr_spaces jtag_axi_0/Data] [get_bd_addr_segs xdma_1/S_AXI_B/BAR0] -force
  ...
  assign_bd_address -offset 0x40000000 -range 0x08000000 -target_address_space [get_bd_addr_spaces pcie_axi] [get_bd_addr_segs xdma_0/S_AXI_B/BAR0] -force
  assign_bd_address -offset 0x48000000 -range 0x02000000 -target_address_space [get_bd_addr_spaces pcie_axi] [get_bd_addr_segs xdma_0/S_AXI_LITE/CTL0] -force
  assign_bd_address -offset 0x60000000 -range 0x20000000 -target_address_space [get_bd_addr_spaces XDMA_S_AXI_B] [get_bd_addr_segs xdma_1/S_AXI_B/BAR0] -force
  assign_bd_address -offset 0x4C000000 -range 0x04000000 -target_address_space [get_bd_addr_spaces pcie_axi] [get_bd_addr_segs xdma_1/S_AXI_LITE/CTL0] -force
