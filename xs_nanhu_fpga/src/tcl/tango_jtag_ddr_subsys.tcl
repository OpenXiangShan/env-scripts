...
proc create_root_design { parentCell } {
  ...
  set_property CONFIG.C_EXT_RST_WIDTH {16} $rst_sys_50M
...
connect_bd_intf_net -intf_net [get_bd_intf_nets S00_AXI_1] [get_bd_intf_pins axi_interconnect_0/S00_AXI] [get_bd_intf_pins jtag_maxi_ila/SLOT_0_AXI]
  ...
  connect_bd_net -net M00_ACLK_1 [get_bd_pins ddr4_0/c0_ddr4_ui_clk] [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins jtag_axi_0/aclk] [get_bd_pins jtag_maxi_ila/clk] [get_bd_pins rst_ddr4_200M/slowest_sync_clk]
  connect_bd_net -net ddr4_0_addn_ui_clkout1 [get_bd_pins ddr4_0/addn_ui_clkout1] [get_bd_ports SOC_CLK] [get_bd_pins axi_interconnect_0/S01_ACLK] [get_bd_pins rst_sys_50M/slowest_sync_clk]
  connect_bd_net -net ddr4_0_addn_ui_clkout2 [get_bd_pins ddr4_0/addn_ui_clkout2] [get_bd_ports MAC_CLK]
  ...
  connect_bd_net -net ddr4_0_c0_init_calib_complete1 [get_bd_pins ddr4_0/c0_init_calib_complete] [get_bd_ports calib_complete] [get_bd_pins rst_ddr4_200M/dcm_locked] [get_bd_pins rst_sys_50M/dcm_locked]
  ...
  connect_bd_net -net rst_ddr4_0_200M_interconnect_aresetn [get_bd_pins rst_ddr4_200M/interconnect_aresetn] [get_bd_pins axi_interconnect_0/ARESETN] [get_bd_pins axi_interconnect_0/S00_ARESETN] [get_bd_pins axi_interconnect_0/M00_ARESETN]
  connect_bd_net -net rst_ddr4_0_200M_peripheral_aresetn [get_bd_pins rst_ddr4_200M/peripheral_aresetn] [get_bd_pins ddr4_0/c0_ddr4_aresetn] [get_bd_pins jtag_axi_0/aresetn]
  connect_bd_net -net rst_sys_50M_interconnect_aresetn [get_bd_pins rst_sys_50M/interconnect_aresetn] [get_bd_pins axi_interconnect_0/S01_ARESETN]
  connect_bd_net -net rst_sys_50M_peripheral_aresetn [get_bd_pins rst_sys_50M/peripheral_aresetn] [get_bd_ports SOC_RESETN]
  connect_bd_net -net soc_rstn_1 [get_bd_ports soc_rstn] [get_bd_pins logic_not1/Op1]
  connect_bd_net -net util_vector_logic_0_Res [get_bd_pins logic_not/Res] [get_bd_pins ddr4_0/sys_rst]
