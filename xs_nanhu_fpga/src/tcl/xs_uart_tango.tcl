...
# IP Build 3064653 on Wed Nov 18 14:17:31 MST 2022
#
...
set cpu "nanhu"
set cpu_candidates [list "nanhu" "xiangshan" "dualcore" "nanhu_tango_19p"]
...
source "$tcl_dir/constraints_tango.tcl"
...
source "$tcl_dir/tango_jtag_ddr_subsys.tcl"
...
if {[string equal [get_runs -quiet synth_1] ""]} {
    create_run -name synth_1 -part xcvu19p-fsva3824-2-e -flow {Vivado Synthesis 2022} -strategy "Vivado Synthesis Defaults" -report_strategy {No Reports} -constrset constrs_1
} else {
...
if {[string equal [get_runs -quiet impl_1] ""]} {
    create_run -name impl_1 -part xcvu19p-fsva3824-2-e -flow {Vivado Implementation 2022} -strategy "Performance_ExplorePostRoutePhysOpt" -report_strategy {No Reports} -constrset constrs_1 -parent_run synth_1
} else {
