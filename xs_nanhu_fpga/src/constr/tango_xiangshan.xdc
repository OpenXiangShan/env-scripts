...
#uart50M_clk_p
#set_property PACKAGE_PIN  [get_ports uart50M_clk_p]
#set_property PACKAGE_PIN  [get_ports uart50M_clk_n]
#1MHz clock, CLK0
set_property PACKAGE_PIN CA39 [get_ports clk8_p]
set_property PACKAGE_PIN CA40 [get_ports clk8_n]
...
# system 10MHz, CLK2
set_property PACKAGE_PIN AY50 [get_ports clk6_p]
set_property PACKAGE_PIN BA50 [get_ports clk6_n]

# debug 50MHz, CLK3
set_property PACKAGE_PIN N44 [get_ports clk5_p] 
set_property PACKAGE_PIN M44 [get_ports clk5_n] 
...
#reset
set_property PACKAGE_PIN AF14 [get_ports rstn_sw6]
set_property PACKAGE_PIN AE15 [get_ports rstn_sw5]
set_property PACKAGE_PIN AG16 [get_ports rstn_sw4]

#uart
set_property PACKAGE_PIN F14 [get_ports uart0_sout]

set_property PACKAGE_PIN G14 [get_ports uart0_sin]

set_property PACKAGE_PIN D16 [get_ports uart1_sout]

set_property PACKAGE_PIN D15 [get_ports uart1_sin]

set_property PACKAGE_PIN T15 [get_ports uart2_sout]

set_property PACKAGE_PIN R15 [get_ports uart2_sin]
#pcie
...
#
#set_property PACKAGE_PIN AT4 [get_ports {PCIE2_RXP[0]}]
#set_property PACKAGE_PIN AT3 [get_ports {PCIE2_RXN[0]}]
#set_property PACKAGE_PIN AV9 [get_ports {PCIE2_TXP[0]}]
#set_property PACKAGE_PIN AV8 [get_ports {PCIE2_TXN[0]}]
#set_property PACKAGE_PIN AR2 [get_ports {PCIE2_RXP[1]}]
#set_property PACKAGE_PIN AR1 [get_ports {PCIE2_RXN[1]}]
#set_property PACKAGE_PIN AU7 [get_ports {PCIE2_TXP[1]}]
#set_property PACKAGE_PIN AU6 [get_ports {PCIE2_TXN[1]}]
#set_property PACKAGE_PIN AP4 [get_ports {PCIE2_RXP[2]}]
#set_property PACKAGE_PIN AP3 [get_ports {PCIE2_RXN[2]}]
#set_property PACKAGE_PIN AT9 [get_ports {PCIE2_TXP[2]}]
#set_property PACKAGE_PIN AT8 [get_ports {PCIE2_TXN[2]}]
#set_property PACKAGE_PIN AN2 [get_ports {PCIE2_RXP[3]}]
#set_property PACKAGE_PIN AN1 [get_ports {PCIE2_RXN[3]}]
#set_property PACKAGE_PIN AR7 [get_ports {PCIE2_TXP[3]}]
#set_property PACKAGE_PIN AR6 [get_ports {PCIE2_TXN[3]}]
...
####### J1
set_property PACKAGE_PIN AH14 [get_ports led0]

#set_property PACKAGE_PIN CB39 [get_ports led1]

set_property PACKAGE_PIN AH13 [get_ports led2]

set_property PACKAGE_PIN AH16 [get_ports led3]
...
##J4
set_property PACKAGE_PIN H4 [get_ports JTAG_TCK]
set_property PACKAGE_PIN M4 [get_ports JTAG_TMS]
set_property PACKAGE_PIN L4 [get_ports JTAG_TDI]
set_property PACKAGE_PIN L2 [get_ports JTAG_TDO]
set_property PACKAGE_PIN M6 [get_ports JTAG_TRSTn]

set_property PACKAGE_PIN E9 [get_ports SD_CLK]
                         
set_property PACKAGE_PIN E8 [get_ports SD_CMD]
                         
set_property PACKAGE_PIN G8 [get_ports SD_DATA0]
                         
set_property PACKAGE_PIN G7 [get_ports SD_DATA1]
                         
set_property PACKAGE_PIN H10 [get_ports SD_DATA2]
                         
set_property PACKAGE_PIN H9 [get_ports SD_DATA3]
                         
set_property PACKAGE_PIN H3 [get_ports SD_DECT]
...
set_property IOSTANDARD LVCMOS18 [get_ports uart1_sout]
set_property IOSTANDARD LVCMOS18 [get_ports uart1_sin]
set_property IOSTANDARD LVCMOS18 [get_ports uart2_sout]
set_property IOSTANDARD LVCMOS18 [get_ports uart2_sin]
...
create_clock -period 100.000 -name CPU_CLK_IN [get_ports clk6_p]
...
###################################################################################################debug
set_clock_groups -asynchronous -group [get_clocks -include_generated_clocks CPU_CLK_IN] -group [get_clocks -include_generated_clocks TMCLK] -group [get_clocks -include_generated_clocks DEBUG_CLK_IN] -group [get_clocks -include_generated_clocks clkp]  -group [get_clocks clk7_p -include_generated_clocks]
set_clock_groups -name setup_debug -asynchronous -group [get_clocks clk7_p] -group [get_clocks clkp]  -group [get_clocks CPU_CLK_IN] -group [get_clocks DEBUG_CLK_IN] -group [get_clocks TMCLK]

set_clock_groups -asynchronous -group [get_clocks -include_generated_clocks CPU_CLK_IN] -group [get_clocks -include_generated_clocks clkp]

set_clock_groups -asynchronous -group [get_clocks -include_generated_clocks DEBUG_CLK_IN] -group [get_clocks -include_generated_clocks clkp]

set_clock_groups -asynchronous -group [get_clocks -include_generated_clocks TMCLK] -group [get_clocks -include_generated_clocks clkp]
