...
####### J3 phy3
set_property PACKAGE_PIN P32 [get_ports MDC]
set_property PACKAGE_PIN P33 [get_ports MDIO]
set_property PACKAGE_PIN T32 [get_ports RGMII_RXCLK]
set_property PACKAGE_PIN R33 [get_ports RGMII_RXDV]
set_property PACKAGE_PIN R32 [get_ports RGMII_RXD0]
set_property PACKAGE_PIN U32 [get_ports RGMII_RXD1]
set_property PACKAGE_PIN U31 [get_ports RGMII_RXD2]
set_property PACKAGE_PIN T31 [get_ports RGMII_RXD3]
set_property PACKAGE_PIN W33 [get_ports RGMII_TXCLK]
set_property PACKAGE_PIN U33 [get_ports RGMII_TXEN]
set_property PACKAGE_PIN M32 [get_ports RGMII_TXD0]
set_property PACKAGE_PIN M31 [get_ports RGMII_TXD1]
set_property PACKAGE_PIN W32 [get_ports RGMII_TXD2]
set_property PACKAGE_PIN V33 [get_ports RGMII_TXD3]
set_property PACKAGE_PIN K33 [get_ports PHY_RESET_B]
