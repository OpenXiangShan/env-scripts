...
def add_license(path):
  ...
  if do_write:
    ...
    dest_content.insert(insert_line, header_content)
    # print(dest_content)
...
add_license(abs("/home/zzf/RISCVERS/XiangShan/src/main/scala/xiangshan/frontend/jbtac.scala"))
